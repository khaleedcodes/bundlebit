...
const MagazineTheme: React.FC<MagazineThemeProps> = ({ bundle }) => {
      ...
      <div className="w-full max-w-lg mx-auto z-10 animate-[fadeIn_1s_ease-out]">
        <div className="relative bg-white p-10 shadow-lg border border-gray-200">
          ...
          <header className="mb-10 border-b border-gray-200 pb-6">
            ...
            <p className="text-xl text-gray-500 font-light italic">The digital presence edition</p>
          </header>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/3">
              <div className="mb-4 relative">
                ...
                <p className="mt-2 text-xs text-gray-500 italic">
                  {bundle.displayName}, digital creator
                </p>
              </div>
            </div>
            ...
            <div className="md:w-2/3">
              <div className="mb-6">
                <h2 className="text-4xl font-bold mb-1">{bundle.displayName}</h2>
                <p className="text-red-600 text-sm font-medium italic">@{bundle.bundleName}</p>
