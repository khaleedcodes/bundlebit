...
interface ScrapbookThemeProps {
  bundle: Bundle;
}

const ScrapbookTheme: React.FC<ScrapbookThemeProps> = ({ bundle }) => {
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mb-6 w-36 bg-white p-2 border-2 border-gray-200 shadow-md transform rotate-[3deg]">
              ...
              <div className="mt-2 mb-1">
                <span className="text-gray-600 text-sm">✨ {bundle.displayName} ✨</span>
              </div>
            </div>
            ...
            {sortedBits.map((bit, index) => (
              <a
                ...
                style={{ 
                  ...
                  backgroundColor: ['bg-pink-100', 'bg-blue-100', 'bg-green-100', 'bg-yellow-100', 'bg-purple-100'][index % 5]
                }}
              >
                {/* Decorative elements */}
